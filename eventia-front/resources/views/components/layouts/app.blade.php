...
<body class="font-sans antialiased text-text-main bg-background flex flex-col min-h-screen"
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-20 items-center">
                ...
                <nav class="hidden md:flex space-x-8">
                    <x-nav-link href="{{ route('public.event-list') }}">Explorar</x-nav-link>
                ...
                <div class="flex items-center gap-4">
                    ...
                    @else
                        <a href="{{ route('login') }}"
                            class="text-text-secondary hover:text-primary transition flex items-center gap-2 group">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
    ...
    <!--DEPENDIENDO DE DONDE SE ENCUENTRE AHORA MISMO EL USUARIO,ESTE CONTENIDO IRÁ CAMBIADO MOSTRANDO UN COMPONENTE U OTRO-->
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                ...
                <div class="flex flex-col items-start md:items-end">
                    ...
                    <div class="flex gap-4">
                        <!-- Social Icons -->
                        <a href="#"
                            class="w-10 h-10 rounded-full bg-white shadow-sm flex items-center justify-center text-text-secondary hover:text-primary hover:shadow-md transition">
                            <!-- Twitter -->
