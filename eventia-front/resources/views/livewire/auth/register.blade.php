        ...
        <div class="p-8 sm:p-10">
            ...
            <!-- Registration Form -->
             <form method="POST" action="{{ route('register') }}" class="space-y-5">
                ...
                <div class="space-y-1">
                    <label for="name" class="block text-sm font-medium text-text-main">Nombre completo</label>
                    <div class="relative">
                ...
                <div class="space-y-1">
                    <label for="password_confirmation" class="block text-sm font-medium text-text-main">Verificar contraseña</label>
                    <div class="relative">
            ...
            <div class="flex items-center justify-center mt-8 pt-6 border-t border-gray-100 text-sm">
                 ...
                 <a href="{{ route('login') }}" class="text-primary hover:text-secondary font-bold transition">Inicia sesión</a>
            </div>
